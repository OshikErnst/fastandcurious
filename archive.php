...
<div id="inner_wrapper">
	<div id="sidebar">
		...
		<div id="text_items_box">
            <?php 
            $dest_category = get_category( get_query_var( 'cat' ) );
            $dest_cat_id = $dest_category->cat_ID;
	...
	<div id="content">
		...
		<div id="inner_content">
            ...
            $main_video = new WP_Query($args);
                if($main_video->have_posts() ) : ?>
                    <?php while( $main_video->have_posts() ) : 
                        $main_video->the_post(); 
                        global $post_id,$post;
			...
			<div id="video_related">
                    ...
                    ?>
                    <?php if($related_video->have_posts() ) : ?>
                	<ul>
                    <?php while( $related_video->have_posts() ) : 
                        $related_video->the_post(); 
                        global $post_id;?>
					<li>
                       
                        <a href="<?php the_permalink(); ?>">
                            <?php $thumb_image_url = wp_get_attachment_image_src( get_post_thumbnail_id(get_the_ID()), 'thumbnail');?>
