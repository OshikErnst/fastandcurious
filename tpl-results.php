...
<div id="inner_wrapper">
	<div id="sidebar">
		...
		<div id="text_items_box">
         <?php 
         $post_categories = $_REQUEST['cats'];
         

            $args = array(
                    'posts_per_page' => 3,
                    'post_type' => 'destination',
                    'category__and' => array( $post_categories ),
                    'orderby' => 'rand',
		...
		<div id="inner_content">
            ...
            $args = array(
        			...
        			$main_video = new WP_Query($args);
                        ...
                        $id_1 = $post->ID;
                        $title_1 = $post->post_title;
                        $content_1 = $post->post_content;
			...
			<div id="video_related">
				<ul>
        			...
        			$rel_videos = new WP_Query($args);
                        if($rel_videos->have_posts() ) : ?>
                            <?php while( $rel_videos->have_posts() ) : 
                                $rel_videos->the_post(); 
                                global $post_id,$post;?>
    					<li>
