...
<div id="inner_wrapper">
		...
		<div id="text_items_box">
         ...
         $post_categories = wp_get_post_categories( get_the_ID() );
            ...
            $cats_toarray = substr($cats_toarray, 0, -1);
			   ...
			   query_posts('showposts=1&p='.get_the_ID().'&post_type=destination');
	...
	<div id="content">
		...
		<div id="inner_content">
            ...
            wp_reset_query(); 
                        query_posts('showposts=1&cat='.$cats_toarray.'&post_type=post');
                        
                        while ( have_posts() ) : the_post();
                        
                        $video_1 = get_the_ID(); 
                        
                        $title_1 = get_the_title($video_1);
                        $content_1 = get_the_excerpt($video_1);
                        ...
                        ?> 
                        <?php $large_image_url = wp_get_attachment_image_src( get_post_thumbnail_id($video_1), 'large');?>
